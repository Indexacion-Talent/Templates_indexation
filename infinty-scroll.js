(function () {
	...
	var ref = document.querySelector('div.JBSearchTemplate'); //Selector que contiene los jobs 
	...
	out["pic"] = true;
	out["html"] = true;
	out["pass_it"]["heights"].push(document.querySelectorAll('div.job-post-row').length);//Selector de los JOBS
	return out;
})();
