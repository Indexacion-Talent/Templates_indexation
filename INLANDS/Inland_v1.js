...
(function () {
    var out = {};
    var selector_jobs = "ul.postingsList";
    var selector_desc = "[id*='DescriptionText']";
    ...
    if (elem) {
        var title = elem.querySelector("[id*='p'] > li.title").textContent.trim();
        //var url = elem.querySelector("").href.trim();
        var location = "Crystal Lake, IL, US";
...
(function() {
    ...
    //window.history.back();
    if (document.querySelector("[id*='p'] > div > span.normal > a"))
