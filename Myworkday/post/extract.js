(function () {
    ...
    $.ajax({
        url: 'https://flextronics.wd1.myworkdayjobs.com/wday/cxs/flextronics/Careers/jobs',
        "headers": {
        ...
        success: function (json) {
            ...
            for (i in jobs) {
                ...
                job.url = "https://flextronics.wd1.myworkdayjobs.com/en-US/Careers" + jobs[i].externalPath;
                ...
                let endpoint = "https://flextronics.wd1.myworkdayjobs.com/wday/cxs/flextronics/Careers" + jobs[i].externalPath;
